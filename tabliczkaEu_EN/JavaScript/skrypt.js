...
//STEINLESS STEEL
	...
	else if(plate.material=='Stainless steel'){
...
//LAMINAT
		...
		else if(plate.material=='Laminate'){
...
// ALUMINIUM
	...
	if((plate.material=='')||(plate.thickness=='')||(plate.height=='')||(plate.width=='')||(plate.quantity=='')){
		...
		var data = {
	    service_id: 'wycena_grupaoficyna_pl',
	    template_id: 'templateen',
	    user_id: 'user_yJSjgmvxfeKQaKx2VCflp',
	    template_params: {
...
function fillingOptions(){
	...
	if((material=='Stainless steel')||(material=='Aluminium')){   
